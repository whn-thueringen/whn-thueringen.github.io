...
const CardContent1Image = ( props: CardProps ) => (
  <>
    ...
    <div class="card d-flex flex-column flex-md-row">
      <div class="col-md-6">
        <img src={props.imgSrc1} alt={props.imgSrc1Alt} class="card-img-top" loading="lazy"></img>
      </div>
      <div class="col-md-6 d-flex flex-column justify-content-center">
        <div class="card-body">
          <h5 class="card-title">{props.title}</h5>
          <p class="card-text">{props.description}</p>
          <a href={props.link} class={props.linkClass} target="_blank">{props.linkText}</a>
        </div>
      </div>
    </div>
  </>
...
const _CardContent2Images = ( props: CardProps ) => (
  <>
    <div class="timeline-date px-4 text-center">{props.date}</div>
    <div class="card d-flex flex-column flex-md-row">
    <div id={props.id} class="carousel" data-bs-ride="carousel">
          <div class="carousel-inner">
              <div class="carousel-item active">
                  <img src={props.imgSrc1} class="card-img-top" alt={props.imgSrc1Alt} data-bs-toggle="modal" data-bs-target="#Kassieraktion_alle_modal" loading="lazy"></img>
              </div>
              <div class="carousel-item">
                  <img src={props.imgSrc2} class="card-img-top" alt={props.imgSrc2Alt} data-bs-toggle="modal" data-bs-target="#Kassieraktion_check_modal" loading="lazy"></img>
              </div>
          </div>
  ...
  <>
    ...
    <div id={props.id} class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
              ...
              <div class="carousel-item">
                  <img src={props.imgSrc3} class="card-img-top" alt={props.imgSrc3Alt} data-bs-toggle="modal" data-bs-target="#Kassieraktion_check_modal" loading="lazy"></img>
              </div>
          </div>
          <button class="carousel-control-prev" type="button" data-bs-target={props.target} data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        ...
        <div class="row justify-content-center">
          <div class="col-md-10 mb-4">
            ...
            <CardContent1Image
              ...
              imgSrc1="../_assets/images/Handballcamp_2024.webp"
              imgSrc2=""  
              imgSrc3=""
